...
$str =
    "Hello World, this is Oluwayanmife Akeju with HNGi7 ID [HNG-00197] with email [yanmifeakeju@gmail.com] using [PHP] for stage two task.";

$str = explode(" ", $str);

foreach ($str as $word) {
    if ($word === '[PHP]') {
        $key = array_search($word, $str);
        unset($str[$key]);
    }
}
